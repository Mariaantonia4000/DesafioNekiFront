...
const HomePage = () => {
  ...
  const ShowDeleteAlert = (id) => {
    Swal.fire({
      icon: "warning",
      title: "Você está prestes a deletar uma associação de skill",
  ...
  const handleDelete = async (id) => {
        ...
        try {
          ...
          if (resultDel.status === 204) {
            Swal.fire({
              icon: "success",
              title: "Associação deletada com sucesso!"
            })
  ...
  return (
    ...
    <Container fluid id="container">
      <Box sx={{ flexGrow: 1, width: "103%"}}>
        <AppBar position="static" sx={{ color: "#2d939c", bgcolor: "#2d939c" }}>
          <Toolbar>
            <Box sx={{ flexGrow: 1 }}>
      ...
      {skills.length > 0 ? (
        ...
        >
          <Table sx={{ minWidth: 700, backgroundColor: "#2d939c", }} aria-label="customized table">
            <TableHead>
              <TableRow>
                <StyledTableCell style={{color: "#2d939c"}}>Imagem</StyledTableCell>
                <StyledTableCell style={{color: "#2d939c"}} align="right">Nome</StyledTableCell>
                <StyledTableCell style={{color: "#2d939c"}} align="right">
                  Nível de conhecimento
                </StyledTableCell>
                <StyledTableCell style={{color: "#2d939c"}} align="right">Ações</StyledTableCell>
              </TableRow>
            </TableHead>
            <TableBody>
        ...
        <>
          <h1 style={{backgroundColor: "#2d939c", borderRadius: "10px", }}>:( Não há nada por aqui ainda...</h1>
          <p style={{backgroundColor: "#2d939c", borderRadius: "10px", }}>Tente cadastrar uma associação de skill no botão abaixo!</p>
        </>
      )}
      ...
      <Dialog open={openModal}>
        <DialogTitle style={{backgroundColor: "#2d939c"}}>Selecione a skill e o nível de conhecimento</DialogTitle>
        <Box sx={{ minWidth: 120, borderRadius: "20px", backgroundColor: "#2d939c", }}>
      ...
      <Dialog open={open}>
        <DialogTitle style={{backgroundColor: "#2d939c"}}>Selecione o novo nível de conhecimento</DialogTitle>
        <Box sx={{ minWidth: 120, display: "flex", justifyContent: "center", backgroundColor: "#2d939c", }}>
          <FormControl id="formControlEdit">
            <InputLabel id="demo-simple-select-label">
              <p style={{ fontSize: 20
               }}>Nivel atual: {knowledgeLevel}</p>
            </InputLabel>
            <Select 
              labelId="demo-simple-select-label"
              id="demo-simple-select"
